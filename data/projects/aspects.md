...
file and user interface one last big obstacle to tackle from our point of view.
...
For example, "UnusedCode" could be an aspects that describes analysis routines,
